...
M.setup = function(options)
	...
	vim.g.nvim_sops_defaults_aws_profile =
		o(options.defaults.awsProfile, vim.g.nvim_sops_defaults_aws_profile, os.getenv("AWS_PROFILE"))
	vim.g.nvim_sops_defaults_age_key_file =
		o(options.defaults.ageKeyFile, vim.g.nvim_sops_defaults_age_key_file, os.getenv("SOPS_AGE_KEY_FILE"))
	vim.g.nvim_sops_defaults_gcp_credentials_path = o(
		options.defaults.gcpCredentialsPath,
		vim.g.nvim_sops_defaults_gcp_credentials_path,
		os.getenv("GOOGLE_APPLICATION_CREDENTIALS")
	)
	vim.g.nvim_sops_defaults_age_public_key =
		o(options.defaults.pubAgeKey, vim.g.nvim.nvim_sops_defaults_age_public_key)
